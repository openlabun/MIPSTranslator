...
describe('TranslatorService I-type instruction tests', () => {
  ...
  describe('Translate load instructions to hex (Both versions)', () => {
    beforeEach(() => {
      service.setVersion('legacy'); // Load instructions existen en ambas versiones
    });
  ...
  describe('Translate hex to load instructions (Both versions)', () => {
    beforeEach(() => {

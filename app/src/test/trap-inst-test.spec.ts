...
describe('TranslatorService I-type instruction tests', () => {
  ...
  describe('Translate trap instructions to hex (LEGACY only)', () => {
    beforeEach(() => {
  ...
  describe('Translate hex to trap instructions (LEGACY only)', () => {
    beforeEach(() => {
      service.setVersion('legacy');
    });
